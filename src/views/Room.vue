<template>
  <div class="room">
    ...
    <div v-else>
      <p style="font-size:20px; margin: 5px 0px">It is <b>BlueCrystal004</b>'s turn.</p>
      <br />
      <table class="hand">
        <tr>
          <td>
        ...
        <tr>
          <td>
            <center><p style="font-size: 20px; margin: 5px 0px">x5</p></center>
          </td>
        </tr>
      </table>
        ...
        <td>
          <div class="box">
            ...
            <div class="margin">
              <p><b>Standings:</b></p>
              <p>
                <b>1. </b><tt>GD</tt> Nico [<b>10</b>] <br /><b>2. </b
                ><tt>LD</tt> frogyfro [<b>10</b>] <br /><b>3. </b
                ><tt>M</tt> Shadow [<b>10</b>] <br /><b>4. </b
                ><tt>M</tt> Illumina [<b>10</b>] <br /><b>5. </b
                ><tt>M</tt> LordGeek101 [<b>10</b>] <br /><b>6. </b
                ><tt>M</tt> dtm [<b>10</b>] <br /><b>7. </b
                ><tt>LP</tt> BlueCrystal004 [<b>10</b>] <br /><b>8. </b
                ><tt>GP</tt> aidanbh123 [<b>10</b>]
              </p>
            </div>
          </div>
        </td>
